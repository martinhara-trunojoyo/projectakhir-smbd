...
<head>
	...
	<title>SIDAK </title>
	<link rel="icon" href="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Seal_of_Bangkalan_Regency.svg/640px-Seal_of_Bangkalan_Regency.svg.png"">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI KEPENDUDUKAN KAB. BANGKALAN</BR></b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Seal_of_Bangkalan_Regency.svg/640px-Seal_of_Bangkalan_Regency.svg.png"" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> SIDAK BANGKALAN</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=laporan-kk" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Laporan KK</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=laporan-pd" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Laporan Penduduk Datang</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=laporan-pl" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Laporan Penduduk Lahir</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=laporan-pp" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Laporan Penduduk Pindah</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=laporan-pm" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Laporan Penduduk Meninggal</p>
									</a>
								</li>
								<!-- <li class="nav-item">
									<a href="#" class="nav-link">
						...
						<li class="nav-header">Activity</li>
							...
							<li class="nav-item">
								<a href="?page=data-log" class="nav-link">
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				// laporan 
				case 'laporan-kk';
					include "laporan/laporan_KK.php";
					break;
				case 'laporan-pd';
					include "laporan/laporan_PD.php";
					break;
				case 'laporan-pl';
					include "laporan/laporan_PL.php";
					break;

				case 'laporan-pm';
					include "laporan/laporan_PM.php";
					break;
				case 'laporan-pp';
					include "laporan/laporan_PP.php";
					break;
				//Pengguna
				case 'data-pengguna':
				...
				// log
				case 'data-log' ;
					include "admin/log/data_log.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.instagram.com/telang-dev/">
